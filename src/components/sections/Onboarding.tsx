  ...
  return (
    <section className="mx-auto max-w-[1400px] px-5 sm:px-8 pt-24">
      ...
      <Reveal className="mt-8">
        <Link
          href="/daftar"
          className="inline-flex items-center gap-2 rounded-full bg-gradient-to-br from-[#00aeef] to-[#0087d1] px-6 py-3 text-[14px] font-semibold text-white shadow-[0_10px_30px_rgba(0,135,209,0.35)] transition-transform hover:scale-[1.03] active:scale-[0.97]"
        >
          Mulai pendaftaran
